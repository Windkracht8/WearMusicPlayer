...
class W8Player : MediaSessionService() {
	...
	private fun startOngoingActivity(notificationBuilder: NotificationCompat.Builder, intent: PendingIntent, status: Status) {
	...
	private fun setChannelImportance(importance: Int){
